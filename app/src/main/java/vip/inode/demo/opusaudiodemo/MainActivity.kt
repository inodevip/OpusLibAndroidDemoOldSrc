...
class MainActivity : AppCompatActivity(), View.OnClickListener, OpusPlayTask.OnOpusPlayListener {
  ...
  val APP_PATH: String =
    Environment.getExternalStorageDirectory().toString() + File.separator + "opusaudiodemo" + File.separator
  ...
  private var recorderDecodedPcmFilePath: String =
    APP_RECORDER_FILE_PATH + "recorderDecoded.pcm"//解码后的PCM文件
