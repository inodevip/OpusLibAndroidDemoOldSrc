/*
 * Coding by Zhonghua. from 18-9-14 下午6:20.
 */
...
class OpusPlayTask(
  ...
  private val opusAudioPath: String,
  recorderDecodedPcmFilePath: String?,
  private val isPCM: Boolean = false
) : Runnable, DecodeOpusPresenter {
  private val bufferSize: Int = AudioTrack.getMinBufferSize(
      DEFAULT_AUDIO_SAMPLE_RATE, AudioFormat.CHANNEL_OUT_MONO, AudioFormat.ENCODING_PCM_16BIT
  )
  ...
  private val audioFormat: AudioFormat = AudioFormat.Builder()
      ...
      .setSampleRate(DEFAULT_AUDIO_SAMPLE_RATE)
  ...
  init {
    audioTrack =
      AudioTrack(audioAttributes, audioFormat, bufferSize, AudioTrack.MODE_STREAM, sessionId)
